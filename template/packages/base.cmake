execute_process(COMMAND ${Python3_EXECUTABLE} ${CMAKE_CURRENT_LIST_DIR}/system.py platform
    OUTPUT_VARIABLE APPLICATION_PACKAGE_NAME
...
set(CPACK_PACKAGE_INSTALL_DIRECTORY @QUOTED_APP_NAME@)
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "midnightBITS/@QUOTABLE_APP_NAME@")
set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}${PROJECT_VERSION_STABILITY}-${APPLICATION_PACKAGE_NAME}")
